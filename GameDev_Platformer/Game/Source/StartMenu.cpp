...
bool StartMenu::LoadState(pugi::xml_node&)
{
	bool ret = true;
	return ret;
}

bool StartMenu::SaveState(pugi::xml_node&) const
{
	bool ret = true;
	return ret;
}
void StartMenu::OnCollision(PhysBody* bodyA, PhysBody* bodyB)
{
	b2Vec2 position;
